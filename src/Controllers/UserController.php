...
class UserController extends Controller {
    ...
    private function ensureAuthenticated() {
        ...
        // Si ce n'est pas un admin, il faut un store_id non null
        if ($_SESSION['user_role'] !== 'Admin' && empty($_SESSION['store_id'])) {
            $_SESSION['error_message'] = "Aucun magasin associé à ce compte";
            $this->redirect('login');
            exit;
        }
    }
    ...
    public function login() {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if ($user) {
                ...
                // Toujours définir store_id (null pour admin)
